...
export const SETTINGS_REGISTRY: SettingDefinition[] = [
  ...
  },
  {
    ...
    type: 'string',
    default: '',
    description: 'NEM KÖTELEZŐ. A LibreOffice indítóprogramjának teljes útvonala, ha nem a szokásos helyen van (ebből készül a Word/Excel/PowerPoint dokumentumok előnézete). Üresen hagyva a Marveen magától megkeresi. Példa Linuxon: /usr/bin/soffice, Windowson: C:\\Program Files\\LibreOffice\\program\\soffice.exe. Ha rossz útvonalat adsz meg, a Munkapad SZÓL róla -- nem keres csendben másik példányt.',
    module: 'munkapad',
    secret: false,
    requiresRestart: false,
  },
  {
    key: 'WORKBENCH_FFMPEG_PATH',
    type: 'string',
    default: '',
    description: 'NEM KÖTELEZŐ. Az FFmpeg teljes útvonala, ha nem a szokásos helyen van (videó- és hangműveletekhez). Üresen hagyva a Marveen magától megkeresi. Példa: /usr/bin/ffmpeg. Enélkül a Munkapad minden más funkciója változatlanul működik.',
    module: 'munkapad',
    secret: false,
    requiresRestart: false,
  },
