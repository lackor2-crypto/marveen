...
const MESSAGES: Record<string, { hu: string; en: string }> = {
  ...
  research_missing: { hu: 'Ez a kutatás nem található.', en: 'This research was not found.' },
  bad_kind: { hu: 'Ismeretlen fül (ötlet, vita vagy kutatás lehet).', en: 'Unknown tab (it can be idea, debate or research).' },
