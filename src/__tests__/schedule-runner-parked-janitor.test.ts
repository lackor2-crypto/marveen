...
vi.mock('../web/scheduled-tasks-io.js', () => ({
  ...
  // A tulajdonos-jelzo (athelyezett telepites detektalasa) nem tartozik
  // ehhez a teszthez: semleges valasz -- nincs korabbi tulajdonos.
  claimScheduleOwnership: () => ({ previousOwner: null, claimed: true }),
}))
