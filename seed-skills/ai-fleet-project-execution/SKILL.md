...
- **Ismeretlen-sender ping-szabály: ELTÁVOLÍTVA ({{OWNER_NAME}}, 2026-08-25, hang 482).** A régi "ismeretlen sender → ping az orchestratornak ELŐSZÖR" aranyszabály megszűnt: nincs igazán ismeretlen küldő, mert a csatorna `allowFrom` allowlistája már kapuz -- csak olyan tud üzenni, akit a tulajdonos MÁR párosított. A dupla kapu (ping + generikus válasz jóváhagyásig) fölöslegesen tétlenné tette az online agentet, biztonsági haszon nélkül. A valódi kapu az allowlist marad; azt NEM piszkáljuk. (A tulajdonos által KÜLSŐ személyre indított delegálás külön eset, lásd a fenti "External-user multi-agent delegation safety scope" pontot -- ott az orchestrator a USER-csatornán tisztázza a hatókört.)
