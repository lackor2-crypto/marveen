...
window._i18n.hu = {
  ...
  'wizclaude.current_ok':     'Ez a gép be van jelentkezve: {who}',
  'wizclaude.current_none':   'Ez a gép jelenleg NINCS bejelentkezve. Emiatt egyik ügynök sem tud dolgozni.',
  ...
  'health.claude_auth_ok':     '✅ A Claude-bejelentkezés él — az ágensek tudnak dolgozni.',
  'health.claude_auth_ok_action': 'Ez az a hozzáférés, ami nélkül semmi nem működne. Ha megszűnik, itt pirosban fog állni, és Telegramon is szólok.',
  'health.claude_auth_lost':   'A Claude-bejelentkezés megszűnt — az ágensek nem tudnak dolgozni.',
  'health.claude_auth_lost_action': 'Nyisd meg az Ubuntu ablakot, írd be: claude — majd a programban: /login, és jelentkezz be. Utána szólj, és újraindítom a szolgáltatásokat. Amíg ez nincs meg, nincs Telegram-válasz, nincs ütemezett feladat.',
  'health.claude_auth_missing': 'Nincs Claude-bejelentkezés beállítva.',
  'health.claude_auth_missing_action': 'Enélkül egyetlen ágens sem indul el. A Beállítások oldalon a Claude-bejelentkezés lépés végigvezet rajta, vagy nyisd meg az Ubuntu ablakot, írd be: claude — majd: /login.',
  ...
  'wizard.item.claude_auth_help': 'Ez a Marveen "agya". Enélkül egyetlen ügynök sem tud gondolkodni, tehát ez tényleg kell. Egy Claude fiókkal kell bejelentkezni a gépen.',
  ...
  'wizard.item.claude_auth_desc': 'Enélkül egyik ágens sem tud gondolkodni. Itt a varázslóban végig lehet csinálni, terminál nélkül.',
