...
window._i18n.hu = {
  ...
  'claudeauth.title':           'Claude-fiók váltása',
  'claudeauth.current':         'Most bejelentkezve: {email}',
  'claudeauth.current_none':    'Jelenleg nincs bejelentkezett Claude-fiók.',
  'claudeauth.lead':            'Itt átválthatsz egy másik Claude-fiókra anélkül, hogy terminált kellene nyitnod. Erre akkor van szükség, ha az egyik fiók kerete elfogyott, vagy másik előfizetéssel akarsz dolgozni.',
  'claudeauth.warn':            'Fontos: ez a fő asszisztens saját bejelentkezését cseréli le. A váltás alatt a futó munka megszakadhat, ezért olyankor csináld, amikor nem futtatsz semmit.',
  'claudeauth.start':           'Bejelentkezés másik fiókkal',
  'claudeauth.email_ph':        'E-mail cím (nem kötelező)',
  'claudeauth.step1':           'Nyisd meg ezt a linket, és jelentkezz be azzal a fiókkal, amit használni szeretnél:',
  ...
  'claudeauth.done':            'Kész, mostantól ezzel a fiókkal dolgozom: {email}',
