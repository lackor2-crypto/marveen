...
window._i18n.hu = {
  ...
  'claudeauth.kind_login':     'bejelentkezés',
  ...
  'claudeauth.lead':            'Itt van egy helyen minden, amivel a Marveen dolgozik: a bejelentkezett fiókok és a beállított kulcsok. Több fiók lehet egyszerre bent, és mindegyik megmarad. Új hozzáadásához válaszd ki alul, melyik szolgáltatóhoz.',
  ...
  'agents.ctx.broker':                 'Ő készíti a munkacsomagokat',
  ...
  'drive.confirm.trash':       'Biztosan a kosárba teszed: "{name}"? (a Drive weben visszaállítható)',
